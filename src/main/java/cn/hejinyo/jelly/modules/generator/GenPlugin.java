package cn.hejinyo.jelly.modules.generator;
...
public class GenPlugin extends PluginAdapter {
    ...
    public static void generate() {
        String config = GenPlugin.class.getClassLoader().getResource("cn/hejinyo/jelly/modules/generator/generator.xml").getFile();
